...
type ContactUsProps = { setSelectedPage: (value: SelectedPage) => void };

const ContactUs = ({ setSelectedPage }: ContactUsProps) => {
  const inputStyles =
    'mb-5 w-full rounded-lg bg-primary-300 px-5 py-3 placeholder-white focus-visible:outline-primary-500';
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              ...
              onSubmit={onSubmit}
              method="POST"
              action="https://formsubmit.co/0d092a5b23042345d1b2787bc0046257"
            >
              <input
          ...
          >
            <div className="w-full before:absolute before:-right-10 before:-bottom-20 before:z-[-1] md:before:content-(--image-evolvetext)">
              <img className="w-full" src={ContactUsPageGraphic} alt="page graphic" />
            </div>
          </motion.div>
        </div>
      </motion.div>
